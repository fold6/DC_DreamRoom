...
*/
          ...
          /* 갤럭시 터시 안되는 이슈로 touchstart추가 수정 + 하니까 되긴하는데 플리 숨/보이기가 안되는.. */

          $(document).ready(function () {
               $(".drag_box_inner_btn .box_playlist").on("click touchend ", function () {
                    let img = $(this).find("img");
          ...
          $(document).ready(function () {
               ...
               function playNextTrack() {
                   ...
                   audio.play();  // Ensure the next track starts playing automatically
               }
               ...
               // Play the audio automatically and set the button to the pause icon when the document is ready
               audio.play();
               ...
               $('#next-button').on("click touchend", playNextTrack);
